...
EXT_LEFT_WALL = py.image.load('images\\structures\\mage_house\\ext_left_wall.png')
...
EXT_RIGHT_WALL = py.image.load('images\\structures\\mage_house\\ext_right_wall.png')

BLUE_ROOF_BACK_LEFT_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_left_connect.png')
BLUE_ROOF_BACK_MID_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_mid_connect.png')
BLUE_ROOF_BACK_RIGHT_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_right_connect.png')
BLUE_ROOF_FRONT_LEFT_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_front_left_connect.png')
BLUE_ROOF_FRONT_MID_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_front_mid_connect.png')
BLUE_ROOF_FRONT_RIGHT_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_front_right_connect.png')
BLUE_ROOF_LEFT = py.image.load('images\\structures\\mage_house\\blue_roof_left.png')
BLUE_ROOF_MID = py.image.load('images\\structures\\mage_house\\blue_roof_mid.png')
BLUE_ROOF_BACK_LEFT_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_back_left_peak.png')
BLUE_ROOF_BACK_LEFT_PEAK_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_left_peak_connect.png')
BLUE_ROOF_BACK_MID_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_back_mid_peak.png')
BLUE_ROOF_BACK_MID_PEAK_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_mid_peak_connect.png')
BLUE_ROOF_BACK_RIGHT_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_back_right_peak.png')
BLUE_ROOF_BACK_RIGHT_PEAK_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_back_right_peak_connect.png')
BLUE_ROOF_FRONT_LEFT_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_front_left_peak.png')
BLUE_ROOF_FRONT_MID_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_front_mid_peak.png')
BLUE_ROOF_FRONT_RIGHT_PEAK = py.image.load('images\\structures\\mage_house\\blue_roof_front_right_peak.png')
BLUE_ROOF_RIGHT = py.image.load('images\\structures\\mage_house\\blue_roof_right.png')
