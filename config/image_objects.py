...
BLUE_ROOF_RIGHT_CONNECT = py.image.load('images\\structures\\mage_house\\blue_roof_right_connect.png')
...
BLUE_ROOF_FRONT_LEFT = py.image.load('images\\structures\\mage_house\\blue_roof_front_left.png')
BLUE_ROOF_FRONT_MID = py.image.load('images\\structures\\mage_house\\blue_roof_front_mid.png')
BLUE_ROOF_FRONT_RIGHT = py.image.load('images\\structures\\mage_house\\blue_roof_front_right.png')
BLUE_ROOF_BACK_LEFT = py.image.load('images\\structures\\mage_house\\blue_roof_back_left.png')
BLUE_ROOF_BACK_MID = py.image.load('images\\structures\\mage_house\\blue_roof_back_mid.png')
BLUE_ROOF_BACK_RIGHT = py.image.load('images\\structures\\mage_house\\blue_roof_back_mid.png')
