...
def get_samwise_node(type):
    if type == 'root':
        ...
        options = [DNO("Definitely! What's your favorite part?", 'second'), DNO("Can I talk to you about a dream I had last night?", 'ominous_dream', condition=['An Ominous Dream', 'Find Samwise']), DNO("Can't talk now, too much to do!", 'exit')]
    elif type == 'second':
