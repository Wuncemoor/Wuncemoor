class EquippableComponent:
    def __init__(self, slot, resource_bonuses=[0,0,0,0],power_bonuses=[0,0,0], spirit_bonuses=[0,0,0,0,0], resist_phys_bonuses=[0,0,0], resist_ele_bonuses=[0,0,0,0,0], hit_dodge_bonuses=[0,0], values=[0,0]):
        self.slot = slot
