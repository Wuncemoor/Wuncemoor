...
def get_player():
    ...
    combatant_component = Combatant('Player', '@', phylo=phylo_component, attributes=attribute_component, level=level_component, competence=competence_component, equipment=equipment_component, inventory=inventory_component)

    
    player = Entity(45, 45, libtcod.white, blocks=True, render_order = RenderOrder.ACTOR, combatant=combatant_component)
...
def get_dungeons(constants):
    ...
    goblin_cave = get_goblin_cave(constants)
    ...
    gob_stairs_comp = Stairs('Stairs', '>', 'goblin_cave', 0, goblin_cave.maps[0].entrance)
    ...
    gob_stairs_up_comp = Stairs('Stairs', '<', 'start', 0, (10,30))
    ...
    kob_stairs_comp = Stairs('Stairs', '>', 'kobold_cave', 0, kobold_cave.maps[0].entrance)
    ...
    kob_stairs_up_comp = Stairs('Stairs', '<', 'start', 0, (10,25))
    ...
    cave_stairs_comp = Stairs('Stairs', '>', 'cave', 0, cave.maps[0].entrance)
    ...
    cave_stairs_up_comp = Stairs('Stairs', '<', 'start', 0, (10,20))
