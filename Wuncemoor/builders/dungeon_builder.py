...
class DungeonBuilder:
    ...
    def get_maps(self):
        ...
        for map in maps:
            ...
            map.fill_map(self.basename, self.subtype, self.np, constants['max_rooms'], constants['room_min_size'], constants['room_max_size'], constants['map_width'], constants['map_height'])
