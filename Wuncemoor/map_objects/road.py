...
class Road:
    ...
    def __init__ (self, rect, go_to_dungeon=None, go_to_floor=None, go_to_xy=None):
        self.rect = rect
    ...
    def set_transitions(self, dimension):
        stairs = Stairs('Stairs', 'images\\alpha.png', self.go_to_dungeon, self.go_to_floor, self.go_to_xy)
