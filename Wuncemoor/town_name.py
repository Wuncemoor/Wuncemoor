...
def town_name_generate():
    ...
    first_possibilities = ['Aber', 'An','And','Ant','Aru','Ban','Bar','Bel','Cyp','Dob','Has','Mo','Oran','Paro','Sli','Step','Suk','Thim','Willem']
    
    second_possibilities = ['ana','ba','buda','dar','dare','dorra','eau','humi','i','jestad','mo','phu','rich','ro','rus','stad','ti','ven']
