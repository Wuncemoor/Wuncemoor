from abstracts.abstract_menu import TopLevelMenu, AbstractMenu
...
from mixins.menu_mixins.menu_primitives.dependent_primitives import DeluxeBlittables


class FancyMenu(DescendingFancyTextData, DescendingStaticImagePointer, DeluxeBlittables, TopLevelMenu):
...
class BasicMenu(DescendingBasicTextData, DescendingStaticImagePointer, DeluxeBlittables, TopLevelMenu):
