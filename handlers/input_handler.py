...
class InputHandler(MVC):
    ...
    def life(self, event):
        if event.key == py.K_F11:
            ...
            return {'show_menus': self.game.model.party.char_sheet}
        elif event.key == py.K_i:
            return {'show_menus': self.game.model.party.inventory}
        elif event.key == py.K_m:
            return {'show_menus': self.game.model.party.map}
        elif event.key == py.K_j:
            return {'show_menus': self.game.model.party.journal}
